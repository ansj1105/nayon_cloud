...
insert into player_progression(account_id, account_exp, highest_stage_unlocked)
values ('00000000-0000-0000-0000-000000000001', 5, 2);
...
test "$($pg_bin/psql -Atqc "select count(*) from pg_class where relkind = 'r' and (relname like 'battle_%' or relname = 'player_progression')")" = "0"
